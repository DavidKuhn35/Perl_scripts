...
my $hit_result 		= $file."nonsynonymous_TopHit_".$timestamp."_parsed.txt";
my $noHit_result 	= $file."nonsynonymous_noTopHit_".$timestamp."_parsed.txt";
my $summary 		= $file."nonsynonymous_".$timestamp."_TopHit_summary.txt";
my %count_total		= ();
my %count_noHit		= ();
my %count_e_hit		= ();
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
