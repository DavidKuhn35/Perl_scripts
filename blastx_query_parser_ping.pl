...
my $hit_result 		= $file."aachange_TopHit_".$timestamp."_parsed.txt";
my $noHit_result 	= $file."aachange_noTopHit_".$timestamp."_parsed.txt";
my $summary 		= $file."aachange_".$timestamp."_TopHit_summary.txt";
my %count_total		= ();
my %count_noHit		= ();
my %count_e_hit		= ();
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
sub main {
	...
	print HIT "Query_name\tQuery_length\tSubject_name\tSubject_source\tSubject_description\tSubject_length\tBest_exp\tScore\tPID\tAlign_length\tStrand\tQuery_start\tQuery_stop\tSubject_start\tSubject_stop\tQuery_sequence\tQuery_frame\n";
