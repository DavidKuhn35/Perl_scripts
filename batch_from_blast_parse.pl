...
#chdir "/home/dkuhn/FrostyPod_2011_working/All_ESTtik_fasta/";
#system "ls -a *.fasta >> fasta_list";
#open(LIBRARY_LIST, "/home/dkuhn/FrostyPod_2011_working/All_ESTtik_fasta/fasta_list" ) || die "Cant open file\n";  #open filehandle for library list
#while (<LIBRARY_LIST>)
#{
